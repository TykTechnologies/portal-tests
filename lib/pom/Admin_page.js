...
class Admin_page extends Page {
    ...
    get ACCESS_REQUESTS_BUTTON() { return new Button_object('a*=Access Requests'); }
    ...
    get THEMES_BUTTON() {return new Button_object('a*=Themes');}
    ...
    openDashboard() {
        ...
        browser.switchWindow(/http:\/\/.*:3001\/$/ig); //TODO change after adding title
    ...
    logOut() {
        ...
        browser.url(config_variables.URL + 'auth/password/logout');
