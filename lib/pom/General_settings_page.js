...
class General_settings_page extends Page {
    ...
    setEmailConfig(config) {
        this.EMAIL_FROM_ADDRESS_INPUT.setValue(config.EMAIL_FROM_ADDRESS);
        this.EMAIL_DEFAULT_FROM_ADDRESS_INPUT.setValue(config.EMAIL_DEFAULT_FROM_ADDRESS);
        this.RESET_EMAIL_SUBJECT_INPUT.setValue(config.RESET_EMAIL_SUBJECT);
        this.APPROVE_EMAIL_SUBJECT_INPUT.setValue(config.APPROVE_EMAIL_SUBJECT);
        this.REJECT_EMAIL_SUBJECT_INPUT.setValue(config.REJECT_EMAIL_SUBJECT);
        this.REGISTER_EMAIL_SUBJECT_INPUT.setValue(config.REGISTER_EMAIL_SUBJECT);
        this.INVITE_EMAIL_SUBJECT_INPUT.setValue(config.INVITE_EMAIL_SUBJECT);
        this.SMTP_HOST_INPUT.setValue(config.SMTP_HOST);
        this.SMTP_PORT_INPUT.setValue(config.SMTP_PORT);
        this.SMTP_USER_INPUT.setValue(config.SMTP_USER);
        this.SMTP_PASS_INPUT.setValue(config.SMTP_PASS);
    }
