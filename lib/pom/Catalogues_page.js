...
class Catalogues_page extends Page {
    ...
    get VISIBILITY_DROPDOWN() {return new Portal_dropDown_object('#select2--container');}
    ...
    addCatalogue(catalogueDetails) {
        ...
        (Array.isArray(catalogueDetails.plans)) ? this.PLANS_DROPDOWN.selectOptions(catalogueDetails.plans) : this.PLANS_DROPDOWN.selectOption(catalogueDetails.plans);
