...
class App_registration_page extends Page {
    ...
    get WELL_KNOWN_URL_INPUT() {return new Input_object('input[name="QorResource.OIDCURL"]');}
    get ACCESS_TOKEN_INPUT() {return new Input_object('input[name="QorResource.RegistrationAccessToken"]');}
