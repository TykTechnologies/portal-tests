...
class Provisioning_requests_page extends Page {
    ...
    get APPROVE_BUTTON() {return new Button_object('//div[@class="qor-slideout__body"]//a[contains(text(),"Approve")]');}
    get REJECT_BUTTON() {return new Button_object('//div[@class="qor-slideout__body"]//a[contains(text(),"Reject")]');}
