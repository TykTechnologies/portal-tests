...
class Dev_catalogues_page extends Page {
    ...
    get PORTAL_IS_PRIVATE_LABEL() { return $('h2*=This Portal is'); }
    ...
    getCountOfDisplayedProducts() {
        return $$(this.cataloguesNamesSelector).length;
    };

}
export const dev_catalogues_page = new Dev_catalogues_page();